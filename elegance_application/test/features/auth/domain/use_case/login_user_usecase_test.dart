...
import 'package:elegance_application/features/auth/domain/use_case/login_user_useCase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    registerFallbackValue(
        LoginUserParams(email: 'test@gmail.com', password: 'test123'));
  });

  test(
      'should call the [AuthRepo.login] with correct email and password (sush@gmail.com, sush123)',
          () async {
        when(() => repository.login(any(), any())).thenAnswer(
              (invocation) async {
            final email = invocation.positionalArguments[0] as String;
            final password = invocation.positionalArguments[1] as String;
            if (email == 'sush@gmail.com' && password == 'sush123') {
        ...
        final result = await useCase(
            LoginUserParams(email: 'sush@gmail.com', password: 'sush123'));
  ...
  test('should return a token when login is successful', () async {
    const email = 'sush@gmail.com';
    const password = 'sush123';
