...
void main() {
  ...
  testWidgets('Email and Password Validation', (WidgetTester tester) async {
    ...
    // Enter text
    await tester.enterText(emailField, 'sush@gmail.com');
    await tester.enterText(passwordField, 'sush123');
    // Ensure UI updates
    await tester.pump();
    // Verify that the text has been entered correctly
    expect(find.text('sush@gmail.com'), findsOneWidget);
    expect(find.text('sush123'), findsOneWidget);
  });
